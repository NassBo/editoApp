...
import fr.nb.ediyo.repository.TagRepository;
import fr.nb.ediyo.service.dto.TagDTO;
import fr.nb.ediyo.service.mapper.TagMapper;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().libelle(DEFAULT_LIBELLE);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().libelle(UPDATED_LIBELLE);
        return tag;
    }
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.libelle(UPDATED_LIBELLE);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.libelle(UPDATED_LIBELLE);
