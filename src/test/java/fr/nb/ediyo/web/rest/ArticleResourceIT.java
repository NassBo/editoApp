...
import fr.nb.ediyo.domain.Article;
import fr.nb.ediyo.domain.Tag;
import fr.nb.ediyo.repository.ArticleRepository;
import fr.nb.ediyo.service.ArticleService;
import fr.nb.ediyo.service.dto.ArticleDTO;
import fr.nb.ediyo.service.mapper.ArticleMapper;
...
class ArticleResourceIT {
    ...
    @Test
    @Transactional
    void checkArticleBodyIsRequired() throws Exception {
        int databaseSizeBeforeTest = articleRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    void checkDateArticleIsRequired() throws Exception {
        int databaseSizeBeforeTest = articleRepository.findAll().size();
        // set the field null
    ...
    void putNewArticle() throws Exception {
        ...
        updatedArticle.userId(UPDATED_USER_ID).title(UPDATED_TITLE).articleBody(UPDATED_ARTICLE_BODY).dateArticle(UPDATED_DATE_ARTICLE);
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.title(UPDATED_TITLE).articleBody(UPDATED_ARTICLE_BODY);
