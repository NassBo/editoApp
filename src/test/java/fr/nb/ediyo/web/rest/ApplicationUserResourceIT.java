...
import fr.nb.ediyo.IntegrationTest;
import fr.nb.ediyo.domain.ApplicationUser;
import fr.nb.ediyo.domain.User;
import fr.nb.ediyo.repository.ApplicationUserRepository;
import fr.nb.ediyo.service.ApplicationUserService;
import fr.nb.ediyo.service.dto.ApplicationUserDTO;
import fr.nb.ediyo.service.mapper.ApplicationUserMapper;
...
class ApplicationUserResourceIT {
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().profilBanner(DEFAULT_PROFIL_BANNER).profilBio(DEFAULT_PROFIL_BIO);
        // Add required entity
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().profilBanner(UPDATED_PROFIL_BANNER).profilBio(UPDATED_PROFIL_BIO);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putNewApplicationUser() throws Exception {
        ...
        updatedApplicationUser.profilBanner(UPDATED_PROFIL_BANNER).profilBio(UPDATED_PROFIL_BIO);
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.profilBanner(UPDATED_PROFIL_BANNER);
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.profilBanner(UPDATED_PROFIL_BANNER).profilBio(UPDATED_PROFIL_BIO);
