...
export const ApplicationUserDeleteDialog = (props: IApplicationUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ediyoApp.applicationUser.delete.question">
        <Translate contentKey="ediyoApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
