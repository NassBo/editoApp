...
export const ArticleUpdate = (props: IArticleUpdateProps) => {
  ...
  const { articleEntity, tags, applicationUsers, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ediyoApp.article.home.createOrEditLabel" data-cy="ArticleCreateUpdateHeading">
            <Translate contentKey="ediyoApp.article.home.createOrEditLabel">Create or edit a Article</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : articleEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="userIdLabel" for="article-userId">
                  <Translate contentKey="ediyoApp.article.userId">User Id</Translate>
                </Label>
                <AvField
                  id="article-userId"
                  data-cy="userId"
              ...
              <AvGroup>
                <Label id="titleLabel" for="article-title">
                  <Translate contentKey="ediyoApp.article.title">Title</Translate>
                </Label>
                <AvField
                  id="article-title"
                  data-cy="title"
              ...
              <AvGroup>
                <Label id="articleBodyLabel" for="article-articleBody">
                  <Translate contentKey="ediyoApp.article.articleBody">Article Body</Translate>
                </Label>
                <AvField
                  id="article-articleBody"
                  data-cy="articleBody"
                  type="text"
                  name="articleBody"
                  validate={{
              ...
              <AvGroup>
                <Label id="dateArticleLabel" for="article-dateArticle">
                  <Translate contentKey="ediyoApp.article.dateArticle">Date Article</Translate>
                </Label>
                <AvField
                  id="article-dateArticle"
                  data-cy="dateArticle"
                  type="date"
                  className="form-control"
                  name="dateArticle"
              ...
              <AvGroup>
                <Label for="article-tags">
                  <Translate contentKey="ediyoApp.article.tags">Tags</Translate>
                </Label>
                <AvInput
                  id="article-tags"
                  data-cy="tags"
                  ...
                  className="form-control"
                  name="tags"
                  value={!isNew && articleEntity.tags && articleEntity.tags.map(e => e.id)}
                >
                  <option value="" key="0" />
                  {tags
              ...
              <AvGroup>
                <Label for="article-applicationUser">
                  <Translate contentKey="ediyoApp.article.applicationUser">Application User</Translate>
                </Label>
                <AvInput
                  id="article-applicationUser"
